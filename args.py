...
class Args:
    def __init__(self):
        ...
        # (0) dataset & models
        self.run_id = 'truthfulqa_llama-7b'
        self.dataset = ['coqa', 'trivia_qa', 'truthful_qa'][2]
        self.llm_model = ['opt-125m', 'llama-7b', 'opt-1.3b', 'opt-2.7b', 'opt-6.7b', 'opt-13b', 'opt-30b', 'opt-66b'][1]
        ...
        self.max_length_of_generated_sequence = 30 # dataset dependant
        self.eos_token_ids = 4                     # 4: "." (period)
        # self.invalid_ids = [673, 894, 13, 903]  # _: 903, 2: <\s>, 50118: "line break", 1209: " Q", 1864: "Q"
        self.invalid_ids = [2, 50118, 1209, 1864] # for opt
